...
const Notification = ({showNotification, setShowNotification}) => {
  ...
  return (
    <div className="relative">
      <div
        className={`w-full h-full bg-opacity-90 top-0 overflow-y-auto ${showNotification ? "hidden" : ""} overflow-x-hidden fixed sticky-0 z-10`}
        id="chef-div"
      >
        <div
          className={`w-full absolute z-10 right-0 h-full overflow-x-hidden transform ${showNotification ? "translate-x-full" : "translate-x-0"}  transition ease-in-out duration-700`}
          id="notification"
        >
