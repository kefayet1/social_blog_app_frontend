                ...
                <div className="bottom px-5 pt-5 pb-[1.4rem]">
                    <div className="authorProfile flex items-center mb-2">
                        <div className="left mr-1">
                            <img
                                src={
                                    "https://images.unsplash.com/photo-1688001247541-43bbd88f77b9?dpr=1&h=200&w=120&auto=format&fit=crop&q=60&ixid=M3wxMjA3fDB8MXxhbGx8fHx8fHx8fHwxNzE5NDgyOTc4fA&ixlib=rb-4.0.3"
                                }
                                alt=""
                        ...
                        <div className="comments flex gap-4 mb-6">
                            ...
                            <div className="commentInfo p-3 bg-[#F1F1F1] rounded-md">
                                ...
                                <div className="commentText text-[#3d3d3d]">
                                    <span>
                                        webpack.prod.js is equal to
                                        webpack.dev.js. Wasn't production
